...
HCSR04_Timer.measure_dist(prefix,interval_ms,record_time, trigger_pin_num, echo_pin_num, sound_speed, write_file)
...
def record_dist(sensor,write_file, rtc, datafile): # requires the sensor, real-time clock, and datafile handles, and whether we are writing a file
	...
	dist = sensor.distance() # take a distance measurement
